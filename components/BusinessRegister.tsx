...
const BusinessRegister = () => {
  ...
  return (
    <div
      className="w-full mx-auto py-3 max-md:px-4 px-6 bg-white rounded-lg"
      style={{
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6" ref={formRef}>
            ...
            {[
              ...
              <div key={option} className="flex items-center">
                <Input
                  ...
                  checked={option === corpsdemetiers}
                  onChange={(e: ChangeEvent<HTMLInputElement>) =>
                    setCorpsdemetiers(e.target.id)
                  }
        ...
        <div className="relative flex flex-col items-start gap-2">
          <Label htmlFor="phone" className="block text-base text-gray-600">
            Téléphone
          </Label>
          <Input
            id="phone"
